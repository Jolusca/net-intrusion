...
contribuindo para a avaliação da robustez dos modelos frente à perda parcial de dados. Os scripts utilizados 
para o pré-processamento e para o treinamento dos modelos 
estão disponíveis no repositório do projeto
\footnote{\url{https://github.com/Jolusca/net-intrusion/tree/main/Ataque-Intrusao-machine}}.
